...
A Model Context Protocol (MCP) server that provides programmatic access to Apple Reminders.
...
git remote add origin git@github.com:bossjones/apple-reminders-mcp.git
