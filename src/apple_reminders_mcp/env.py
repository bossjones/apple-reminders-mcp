"""Environment settings for the Apple Reminders MCP application."""
...
class McpSettings(BaseSettings):
    ...
    storage_root: Path = Field(
        Path.cwd() / ".storage", description="Root directory for file storage", validation_alias="STORAGE_ROOT"
    )
